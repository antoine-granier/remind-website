          ...
          <footer className="w-full py-8 bg-primary text-background2 flex flex-col items-center text-center gap-4">
            ...
            <div className="text-sm tracking-wide px-4 flex items-center gap-1">
              <Link className="text-action hover:underline whitespace-nowrap flex items-center gap-1" href="https://antoine-granier.vercel.app/" target="_blank">
                <svg className="size-4 text-white" data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
